...
<head>
	...
	<title>Dashboard Admin Solit Computer</title>
	...
	<link rel="stylesheet" href="{{ asset('style/assets/css/atlantis.min.css') }}">
...
<body data-background-color="dark">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('style/assets/img/jm_denis.jpg') }}" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('style/assets/img/chadengle.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('style/assets/img/mlane.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('style/assets/img/talha.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('style/assets/img/profile2.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{ asset('style/assets/img/profile.jpg') }}" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
	...
	<script src="{{ asset('style/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js') }}"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="{{ asset('style/assets/js/plugin/jqvmap/jquery.vmap.min.js') }}"></script>
	<script src="{{ asset('style/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js') }}"></script>

	<!-- Sweet Alert -->
	<script src="{{ asset('style/assets/js/plugin/sweetalert/sweetalert.min.js') }}"></script>

	<!-- Atlantis JS -->
	<script src="{{ asset('style/assets/js/atlantis.min.js') }}"></script>
